...
<?php $page_title = 'Staff: Salesperson ' . htmlspecialchars($salesperson['first_name']) . " " . htmlspecialchars($salesperson['last_name']); ?>
...
<div id="main-content">
  ...
  ?>
  <br />
  <a href="edit.php?id=<?php echo urlencode($salesperson['id']); ?>">Edit</a><br />
</div>
