<?php
  ...
  function validate_country($country, $errors=array()) {
    ...
    if (is_blank($country['code'])) {
      ...
      $errors[] = "Code must be Two Capital Letters.";
    } elseif (!has_length($country['code'], array('max' => 2))) {
      $errors[] = "Code must have 2 characters.";
    }
  ...
  function validate_state($state, $errors=array()) {
    ...
    if (is_blank($state['code'])) {
      ...
      $errors[] = "Code must be Capital Letter.";
    } elseif (!has_length($state['code'], array('max' => 2))) {
      $errors[] = "Code must have 2 characters.";
    }
